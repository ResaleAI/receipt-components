...
var lu = (e, u, t) => u in e ? ou(e, u, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[u] = t;
var B = (e, u, t) => (lu(e, typeof u != "symbol" ? u + "" : u, t), t);
const p = {
  ESC: 27,
  LF: 10,
  NUL: 0,
  GS: 29
}, hu = (e) => e ? e.reduce((u, t) => [...u, ...t], []) : [];
async function v(e, u) {
  if (!e)
    return [];
  let t = [];
  for (const a of e)
...
function xu(e, u) {
  ...
  for (const i of e.split(" "))
    a.length + i.length > u && (t.push(a), a = ""), a += i + " ";
...
const mu = {
  ...
  async buildEscPos({ mode: e }, u, t) {
    const a = mu[e];
    if (!t)
      throw new Error("No context found");
    const i = M(t);
    return i.currentAlign === a ? v(u, t) : (i.currentAlign = a, [
      p.ESC,
      l("a"),
      a,
      ...await v(u, i),
  ...
  async buildEscPos({ width: e, height: u }, t, a) {
    ...
    const i = M(a);
    return i.scaleBits &= 240, i.scaleBits |= u - 1, i.scaleBits &= 15, i.scaleBits |= e - 1 << 4, i.scaleBits === a.scaleBits ? v(t) : [
      p.GS,
      l("!"),
      i.scaleBits,
      ...await v(t, i),
  ...
  async buildEscPos(e, u, t) {
    const a = e.bold !== void 0 ? k.bold : 0, i = e.font === "2" ? k.font2 : k.font1, s = e.underline !== void 0 ? k.underline : 0;
    if (!t)
      throw new Error("Context is required for text node");
    const r = M(t);
    let d = r.textMode;
    d |= a | s, d & k.font2 ? d &= i : d |= i, e.reset !== void 0 && (d = 0);
    let o = [...await v(u, r)];
    const h = Iu(i, r);
    let g = 0;
    return r.multiLine && (o = o.reduce((S, A, I) => (I + 1 - g) % h === 0 ? (g++, [...S, A, l(`
`)]) : [...S, A], [])), d === r.textMode ? o : (r.textMode = d, [
      p.ESC,
      l("!"),
      d,
      ...o,
...
function Iu(e, { scaleBits: u }) {
  const t = e ? Eu : yu, a = (u >>> 4) + 1;
  return t / a;
}
const Nu = {
  buildHtml(e, u) {
...
function Bu(e, u, t) {
  let a = e, i = t, s = -1, r = -1, d = "", o = !1, h = [];
  for (; i < u.length; i++) {
    const g = u[i];
    if (a[g] === void 0 && a["*"] === void 0) {
      r = t + 1, t = -1, d = "";
      break;
    }
    if (d += a[g] ? `${g}` : "*", a = a[g] ?? a["*"], a["*"] !== void 0 && h.push(g), Du(a)) {
      r = i + 1, s = i - t + 1, o = !0;
      break;
    }
  }
  return { success: o, startIdx: t, length: s, newIdx: r, patternStr: d, vars: h };
}
function Du(e) {
  for (let u in e)
    return !1;
...
const Vu = /* @__PURE__ */ new Map([
  ...
  (_ = String.fromCodePoint) !== null && _ !== void 0 ? _ : function(e) {
    let u = "";
...
function Ru(e) {
  var u;
  return e >= 55296 && e <= 57343 || e > 1114111 ? 65533 : (u = Vu.get(e)) !== null && u !== void 0 ? u : e;
}
var m;
(function(e) {
...
function Ou(e) {
  return e >= m.UPPER_A && e <= m.UPPER_Z || e >= m.LOWER_A && e <= m.LOWER_Z || P(e);
}
function Mu(e) {
  return e === m.EQUALS || Ou(e);
}
var x;
(function(e) {
...
class eu {
  constructor(u, t, a) {
    this.decodeTree = u, this.emitCodePoint = t, this.errors = a, this.state = x.EntityStart, this.consumed = 1, this.result = 0, this.treeIndex = 0, this.excess = 1, this.decodeMode = y.Strict;
  }
  ...
  stateNumericStart(u, t) {
    return t >= u.length ? -1 : (u.charCodeAt(t) | Pu) === m.LOWER_X ? (this.state = x.NumericHex, this.consumed += 1, this.stateNumericHex(u, t + 1)) : (this.state = x.NumericDecimal, this.stateNumericDecimal(u, t));
  }
  ...
  emitNumericEntity(u, t) {
    ...
    if (u === m.SEMI)
      ...
      return 0;
    return this.emitCodePoint(Ru(this.result), this.consumed), this.errors && (u !== m.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
  }
  /**
  ...
  stateNamedEntity(u, t) {
    ...
    let i = a[this.treeIndex], s = (i & T.VALUE_LENGTH) >> 14;
    for (; t < u.length; t++, this.excess++) {
      const r = u.charCodeAt(t);
      if (this.treeIndex = Hu(a, i, this.treeIndex + Math.max(1, s), r), this.treeIndex < 0)
        ...
        Mu(r)) ? 0 : this.emitNotTerminatedNamedEntity();
      if (i = a[this.treeIndex], s = (i & T.VALUE_LENGTH) >> 14, s !== 0) {
        if (r === m.SEMI)
  ...
  emitNotTerminatedNamedEntity() {
    var u;
    const { result: t, decodeTree: a } = this, i = (a[t] & T.VALUE_LENGTH) >> 14;
  ...
  emitNamedEntityData(u, t, a) {
    ...
    return this.emitCodePoint(t === 1 ? i[u] & ~T.VALUE_LENGTH : i[u + 1], a), t === 3 && this.emitCodePoint(i[u + 2], a), a;
  }
  /**
...
function tu(e) {
  let u = "";
  const t = new eu(e, (a) => u += R(a));
  return function(i, s) {
    let r = 0, d = 0;
    for (; (d = i.indexOf("&", d)) >= 0; ) {
      u += i.slice(r, d), t.startEntity(s);
      const h = t.write(
        i,
        // Skip the "&"
        d + 1
...
function Hu(e, u, t, a) {
  const i = (u & T.BRANCH_LENGTH) >> 7, s = u & T.JUMP_TABLE;
  if (i === 0)
    return s !== 0 && a === s ? t : -1;
  if (s) {
    const o = a - s;
...
class Fu {
  constructor({ xmlMode: u = !1, decodeEntities: t = !0 }, a) {
    this.cbs = a, this.state = c.Text, this.buffer = "", this.sectionStart = 0, this.index = 0, this.entityStart = 0, this.baseState = c.Text, this.isSpecial = !1, this.running = !0, this.offset = 0, this.currentSequence = void 0, this.sequenceIndex = 0, this.xmlMode = u, this.decodeEntities = t, this.entityDecoder = new eu(u ? uu : K, (i, s) => this.emitCodePoint(i, s));
  }
  reset() {
  ...
  stateText(u) {
    u === n.Lt || !this.decodeEntities && this.fastForwardTo(n.Lt) ? (this.index > this.sectionStart && this.cbs.ontext(this.sectionStart, this.index), this.state = c.BeforeTagName, this.sectionStart = this.index) : this.decodeEntities && u === n.Amp && this.startEntity();
  }
  ...
  stateInSpecialTag(u) {
    ...
    (u | 32) === this.currentSequence[this.sequenceIndex] ? this.sequenceIndex += 1 : this.sequenceIndex === 0 ? this.currentSequence === w.TitleEnd ? this.decodeEntities && u === n.Amp && this.startEntity() : this.fastForwardTo(n.Lt) && (this.sequenceIndex = 1) : this.sequenceIndex = +(u === n.Lt);
  }
  stateCDATASequence(u) {
    u === w.Cdata[this.sequenceIndex] ? ++this.sequenceIndex === w.Cdata.length && (this.state = c.InCommentLike, this.currentSequence = w.CdataEnd, this.sequenceIndex = 0, this.sectionStart = this.index + 1) : (this.sequenceIndex = 0, this.state = c.InDeclaration, this.stateInDeclaration(u));
  }
  /**
   ...
   */
  isTagStartChar(u) {
    return this.xmlMode ? !D(u) : Gu(u);
  }
  startSpecial(u, t) {
    this.isSpecial = !0, this.currentSequence = u, this.sequenceIndex = t, this.state = c.SpecialStartSequence;
  }
  stateBeforeTagName(u) {
    if (u === n.ExclamationMark)
      this.state = c.BeforeDeclaration, this.sectionStart = this.index + 1;
    else if (u === n.Questionmark)
      this.state = c.InProcessingInstruction, this.sectionStart = this.index + 1;
    else if (this.isTagStartChar(u)) {
      const t = u | 32;
      this.sectionStart = this.index, !this.xmlMode && t === w.TitleEnd[2] ? this.startSpecial(w.TitleEnd, 3) : this.state = !this.xmlMode && t === w.ScriptEnd[2] ? c.BeforeSpecialS : c.InTagName;
    } else
      u === n.Slash ? this.state = c.BeforeClosingTagName : (this.state = c.Text, this.stateText(u));
  }
  stateInTagName(u) {
  ...
  stateBeforeClosingTagName(u) {
    N(u) || (u === n.Gt ? this.state = c.Text : (this.state = this.isTagStartChar(u) ? c.InClosingTagName : c.InSpecialComment, this.sectionStart = this.index));
  }
  stateInClosingTagName(u) {
    (u === n.Gt || N(u)) && (this.cbs.onclosetag(this.sectionStart, this.index), this.sectionStart = -1, this.state = c.AfterClosingTagName, this.stateAfterClosingTagName(u));
  }
  stateAfterClosingTagName(u) {
    (u === n.Gt || this.fastForwardTo(n.Gt)) && (this.state = c.Text, this.sectionStart = this.index + 1);
  }
  stateBeforeAttributeName(u) {
    u === n.Gt ? (this.cbs.onopentagend(this.index), this.isSpecial ? (this.state = c.InSpecialTag, this.sequenceIndex = 0) : this.state = c.Text, this.sectionStart = this.index + 1) : u === n.Slash ? this.state = c.InSelfClosingTag : N(u) || (this.state = c.InAttributeName, this.sectionStart = this.index);
  }
  stateInSelfClosingTag(u) {
    u === n.Gt ? (this.cbs.onselfclosingtag(this.index), this.state = c.Text, this.sectionStart = this.index + 1, this.isSpecial = !1) : N(u) || (this.state = c.BeforeAttributeName, this.stateBeforeAttributeName(u));
  }
  stateInAttributeName(u) {
    (u === n.Eq || D(u)) && (this.cbs.onattribname(this.sectionStart, this.index), this.sectionStart = -1, this.state = c.AfterAttributeName, this.stateAfterAttributeName(u));
  }
  stateAfterAttributeName(u) {
    u === n.Eq ? this.state = c.BeforeAttributeValue : u === n.Slash || u === n.Gt ? (this.cbs.onattribend(E.NoValue, this.index), this.state = c.BeforeAttributeName, this.stateBeforeAttributeName(u)) : N(u) || (this.cbs.onattribend(E.NoValue, this.index), this.state = c.InAttributeName, this.sectionStart = this.index);
  }
  stateBeforeAttributeValue(u) {
    u === n.DoubleQuote ? (this.state = c.InAttributeValueDq, this.sectionStart = this.index + 1) : u === n.SingleQuote ? (this.state = c.InAttributeValueSq, this.sectionStart = this.index + 1) : N(u) || (this.sectionStart = this.index, this.state = c.InAttributeValueNq, this.stateInAttributeValueNoQuotes(u));
  }
  handleInAttributeValue(u, t) {
    u === t || !this.decodeEntities && this.fastForwardTo(t) ? (this.cbs.onattribdata(this.sectionStart, this.index), this.sectionStart = -1, this.cbs.onattribend(t === n.DoubleQuote ? E.Double : E.Single, this.index), this.state = c.BeforeAttributeName) : this.decodeEntities && u === n.Amp && this.startEntity();
  }
  stateInAttributeValueDoubleQuotes(u) {
    this.handleInAttributeValue(u, n.DoubleQuote);
  }
  stateInAttributeValueSingleQuotes(u) {
    this.handleInAttributeValue(u, n.SingleQuote);
  }
  stateInAttributeValueNoQuotes(u) {
    N(u) || u === n.Gt ? (this.cbs.onattribdata(this.sectionStart, this.index), this.sectionStart = -1, this.cbs.onattribend(E.Unquoted, this.index), this.state = c.BeforeAttributeName, this.stateBeforeAttributeName(u)) : this.decodeEntities && u === n.Amp && this.startEntity();
  }
  stateBeforeDeclaration(u) {
    u === n.OpeningSquareBracket ? (this.state = c.CDATASequence, this.sequenceIndex = 0) : this.state = u === n.Dash ? c.BeforeComment : c.InDeclaration;
  }
  stateInDeclaration(u) {
    (u === n.Gt || this.fastForwardTo(n.Gt)) && (this.cbs.ondeclaration(this.sectionStart, this.index), this.state = c.Text, this.sectionStart = this.index + 1);
  }
  stateInProcessingInstruction(u) {
    (u === n.Gt || this.fastForwardTo(n.Gt)) && (this.cbs.onprocessinginstruction(this.sectionStart, this.index), this.state = c.Text, this.sectionStart = this.index + 1);
  }
  stateBeforeComment(u) {
    u === n.Dash ? (this.state = c.InCommentLike, this.currentSequence = w.CommentEnd, this.sequenceIndex = 2, this.sectionStart = this.index + 1) : this.state = c.InDeclaration;
  }
  stateInSpecialComment(u) {
    (u === n.Gt || this.fastForwardTo(n.Gt)) && (this.cbs.oncomment(this.sectionStart, this.index, 0), this.state = c.Text, this.sectionStart = this.index + 1);
  }
  stateBeforeSpecialS(u) {
    const t = u | 32;
    t === w.ScriptEnd[3] ? this.startSpecial(w.ScriptEnd, 4) : t === w.StyleEnd[3] ? this.startSpecial(w.StyleEnd, 4) : (this.state = c.InTagName, this.stateInTagName(u));
  }
  startEntity() {
    this.baseState = this.state, this.state = c.InEntity, this.entityStart = this.index, this.entityDecoder.startEntity(this.xmlMode ? y.Strict : this.baseState === c.Text || this.baseState === c.InSpecialTag ? y.Legacy : y.Attribute);
  }
  stateInEntity() {
  ...
  handleTrailingData() {
    ...
    this.sectionStart >= u || (this.state === c.InCommentLike ? this.currentSequence === w.CdataEnd ? this.cbs.oncdata(this.sectionStart, u, 0) : this.cbs.oncomment(this.sectionStart, u, 0) : this.state === c.InTagName || this.state === c.BeforeAttributeName || this.state === c.BeforeAttributeValue || this.state === c.AfterAttributeName || this.state === c.InAttributeName || this.state === c.InAttributeValueSq || this.state === c.InAttributeValueDq || this.state === c.InAttributeValueNq || this.state === c.InClosingTagName || this.cbs.ontext(this.sectionStart, u));
  }
  emitCodePoint(u, t) {
...
const q = /* @__PURE__ */ new Set([
  ...
  "datalist",
  "textarea"
]), b = /* @__PURE__ */ new Set(["p"]), $ = /* @__PURE__ */ new Set(["thead", "tbody"]), j = /* @__PURE__ */ new Set(["dd", "dt"]), Q = /* @__PURE__ */ new Set(["rt", "rp"]), Cu = /* @__PURE__ */ new Map([
...
class ju {
  constructor(u, t = {}) {
    var a, i, s, r, d;
    this.options = t, this.startIndex = 0, this.endIndex = 0, this.openTagStart = 0, this.tagname = "", this.attribname = "", this.attribvalue = "", this.attribs = null, this.stack = [], this.buffers = [], this.bufferOffset = 0, this.writeIndex = 0, this.ended = !1, this.cbs = u ?? {}, this.htmlMode = !this.options.xmlMode, this.lowerCaseTagNames = (a = t.lowerCaseTags) !== null && a !== void 0 ? a : this.htmlMode, this.lowerCaseAttributeNames = (i = t.lowerCaseAttributeNames) !== null && i !== void 0 ? i : this.htmlMode, this.tokenizer = new ((s = t.Tokenizer) !== null && s !== void 0 ? s : Fu)(this.options, this), this.foreignContext = [!this.htmlMode], (d = (r = this.cbs).onparserinit) === null || d === void 0 || d.call(r, this);
  }
  ...
  ontextentity(u, t) {
    var a, i;
    this.endIndex = t - 1, (i = (a = this.cbs).ontext) === null || i === void 0 || i.call(a, R(u)), this.startIndex = t;
  }
  /**
  ...
  emitOpenTag(u) {
    ...
    const r = this.htmlMode && Cu.get(u);
    if (r)
  ...
  onclosetag(u, t) {
    ...
    if (this.lowerCaseTagNames && (S = S.toLowerCase()), this.htmlMode && (W.has(S) || Z.has(S)) && this.foreignContext.shift(), this.isVoidElement(S))
      this.htmlMode && S === "br" && ((r = (s = this.cbs).onopentagname) === null || r === void 0 || r.call(s, "br"), (o = (d = this.cbs).onopentag) === null || o === void 0 || o.call(d, "br", {}, !0), (g = (h = this.cbs).onclosetag) === null || g === void 0 || g.call(h, "br", !1));
    else {
      const A = this.stack.indexOf(S);
      if (A !== -1)
        for (let I = 0; I <= A; I++) {
          const L = this.stack.shift();
          (i = (a = this.cbs).onclosetag) === null || i === void 0 || i.call(a, L, I !== A);
        }
      else
  ...
  /** @internal */
  onattribentity(u) {
    this.attribvalue += R(u);
  }
  /** @internal */
  onattribend(u, t) {
    var a, i;
    this.endIndex = t, (i = (a = this.cbs).onattribute) === null || i === void 0 || i.call(a, this.attribname, this.attribvalue, u === E.Double ? '"' : u === E.Single ? "'" : u === E.NoValue ? void 0 : null), this.attribs && !Object.prototype.hasOwnProperty.call(this.attribs, this.attribname) && (this.attribs[this.attribname] = this.attribvalue), this.attribvalue = "";
  }
  ...
  oncomment(u, t, a) {
    var i, s, r, d;
    this.endIndex = t, (s = (i = this.cbs).oncomment) === null || s === void 0 || s.call(i, this.getSlice(u, t - a)), (d = (r = this.cbs).oncommentend) === null || d === void 0 || d.call(r), this.startIndex = t + 1;
  }
  /** @internal */
  oncdata(u, t, a) {
    var i, s, r, d, o, h, g, S, A, I;
    this.endIndex = t;
    const L = this.getSlice(u, t - a);
    !this.htmlMode || this.options.recognizeCDATA ? ((s = (i = this.cbs).oncdatastart) === null || s === void 0 || s.call(i), (d = (r = this.cbs).ontext) === null || d === void 0 || d.call(r, L), (h = (o = this.cbs).oncdataend) === null || h === void 0 || h.call(o)) : ((S = (g = this.cbs).oncomment) === null || S === void 0 || S.call(g, `[CDATA[${L}]]`), (I = (A = this.cbs).oncommentend) === null || I === void 0 || I.call(A)), this.startIndex = t + 1;
  }
  /** @internal */
  onend() {
    var u, t;
...
function nu(e, u = !1) {
  ...
  if (Ju(e))
    ...
    const a = u ? V(e.children) : [], i = new ru(e.name, { ...e.attribs }, a);
...
class u0 {
   ...
   */
  constructor(u, t, a) {
    this.dom = [], this.root = new O(this.dom), this.done = !1, this.tagStack = [this.root], this.lastNode = null, this.parser = null, typeof t == "function" && (a = t, t = J), typeof u == "object" && (t = u, u = void 0), this.callback = u ?? null, this.options = t ?? J, this.elementCB = a ?? null;
  }
  onparserinit(u) {
    this.parser = u;
  }
  ...
  onopentag(u, t) {
    const a = this.options.xmlMode ? f.Tag : void 0, i = new ru(u, t, void 0, a);
...
function du(e, u) {
  const t = new u0(void 0, u);
  return new ju(t, u).end(e), t.root;
}
async function e0(e, u, t, a) {
  const i = e.replace(/\n\s*/g, ""), s = du(i, { xmlMode: !0 });
  return fu(s.children[0], u, t, a);
}
async function fu(e, u, t, a) {
  if (e.type === f.Tag) {
    const i = u[e.name];
    if (!i)
  ...
  return e.type === f.Text ? e.data === "{ children }" ? v(a) : Nu.buildEscPos({ text: e.data }, [], t) : [];
}
function t0(e, u, t) {
  const a = e.replace(/\n\s*/g, ""), i = du(a, { xmlMode: !0 });
  return bu(i.children[0], u, t);
}
function bu(e, u, t) {
  if (e.type === f.Tag) {
    const a = u[e.name];
...
class s0 {
  constructor({
    ...
    B(this, "template");
    B(this, "skipOptimization");
    B(this, "nodeRegistry");
    this.template = u, this.skipOptimization = !!a, this.nodeRegistry = { ...a0, ...t };
  }
  async render(u, t = !1) {
    return t ? await this.buildHtml(u) : await this.buildEscPos(u);
  }
  buildHtml(u, t) {
    const a = F(this.template, u);
    return t0(a, this.nodeRegistry, t);
  }
  async buildEscPos(u, t, a = i0) {
    const i = F(this.template, u), s = await e0(
      i,
      this.nodeRegistry,
      a,
      t
    );
    return this.skipOptimization ? s : _u(s);
  }
}
export {
  s0 as default
