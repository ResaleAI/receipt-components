...
var B = (e, u, t) => (xu(e, typeof u != "symbol" ? u + "" : u, t), t);
const p = {
  ESC: 27,
  LF: 10,
  NUL: 0,
...
const R = {
  ...
  async buildEscPos({ mode: e }, u, t) {
    ...
    return a !== R.left && i.push(p.ESC, l("a"), R.left), i;
  }
}, gu = {
  lines: 1
}, $ = {
  ...
  async buildEscPos(e, u, t) {
    const a = e.bold !== void 0 ? D.bold : 0, i = e.font === "2" ? D.font2 : D.font1;
    if (console.log("parentCtx: ", t), !t)
      throw new Error("Context is required for text node");
    const s = Y(t);
    let r = s.textMode;
    return r |= a, r & D.font2 ? r &= i : r |= i, e.reset !== void 0 && (r = 0), r === s.textMode ? I(u, s) : (s.textMode = r, [
      p.ESC,
      l("!"),
      r,
      ...await I(u, s),
...
function Lu(e) {
  return e >= m.UPPER_A && e <= m.UPPER_Z || e >= m.LOWER_A && e <= m.LOWER_Z || M(e);
}
function Ru(e) {
...
class Ou {
  ...
  stateInTagName(u) {
    _(u) && (this.cbs.onopentagname(this.sectionStart, this.index), this.sectionStart = -1, this.state = c.BeforeAttributeName, this.stateBeforeAttributeName(u));
  }
  ...
  stateInAttributeName(u) {
    (u === d.Eq || _(u)) && (this.cbs.onattribname(this.sectionStart, this.index), this.sectionStart = -1, this.state = c.AfterAttributeName, this.stateAfterAttributeName(u));
  }
...
const v = /* @__PURE__ */ new Set([
  ...
  "datalist",
  "textarea"
]), b = /* @__PURE__ */ new Set(["p"]), j = /* @__PURE__ */ new Set(["thead", "tbody"]), Q = /* @__PURE__ */ new Set(["dd", "dt"]), W = /* @__PURE__ */ new Set(["rt", "rp"]), Uu = /* @__PURE__ */ new Map([
...
class Gu {
  constructor(u, t = {}) {
    var a, i, s, r, n;
    this.options = t, this.startIndex = 0, this.endIndex = 0, this.openTagStart = 0, this.tagname = "", this.attribname = "", this.attribvalue = "", this.attribs = null, this.stack = [], this.buffers = [], this.bufferOffset = 0, this.writeIndex = 0, this.ended = !1, this.cbs = u ?? {}, this.htmlMode = !this.options.xmlMode, this.lowerCaseTagNames = (a = t.lowerCaseTags) !== null && a !== void 0 ? a : this.htmlMode, this.lowerCaseAttributeNames = (i = t.lowerCaseAttributeNames) !== null && i !== void 0 ? i : this.htmlMode, this.tokenizer = new ((s = t.Tokenizer) !== null && s !== void 0 ? s : Ou)(this.options, this), this.foreignContext = [!this.htmlMode], (n = (r = this.cbs).onparserinit) === null || n === void 0 || n.call(r, this);
  }
  ...
  emitOpenTag(u) {
    ...
    const r = this.htmlMode && Uu.get(u);
    if (r)
  ...
  onclosetag(u, t) {
    ...
    if (this.lowerCaseTagNames && (S = S.toLowerCase()), this.htmlMode && (Z.has(S) || J.has(S)) && this.foreignContext.shift(), this.isVoidElement(S))
      this.htmlMode && S === "br" && ((r = (s = this.cbs).onopentagname) === null || r === void 0 || r.call(s, "br"), (o = (n = this.cbs).onopentag) === null || o === void 0 || o.call(n, "br", {}, !0), (T = (h = this.cbs).onclosetag) === null || T === void 0 || T.call(h, "br", !1));
    else {
  ...
  /** @internal */
  oncdata(u, t, a) {
    var i, s, r, n, o, h, T, S, q, N;
    this.endIndex = t;
    const k = this.getSlice(u, t - a);
    !this.htmlMode || this.options.recognizeCDATA ? ((s = (i = this.cbs).oncdatastart) === null || s === void 0 || s.call(i), (n = (r = this.cbs).ontext) === null || n === void 0 || n.call(r, k), (h = (o = this.cbs).oncdataend) === null || h === void 0 || h.call(o)) : ((S = (T = this.cbs).oncomment) === null || S === void 0 || S.call(T, `[CDATA[${k}]]`), (N = (q = this.cbs).oncommentend) === null || N === void 0 || N.call(q)), this.startIndex = t + 1;
  }
  /** @internal */
  onend() {
    var u, t;
...
class L {
  constructor({
    ...
    B(this, "nodeRegistry");
    this.template = u, this.skipOptimization = !!a, this.nodeRegistry = { ...Yu, ...t };
  }
  async render(u, t = !1) {
  ...
  async buildEscPos(u, t, a = Ku) {
    const i = z(this.template, u), s = await Ju(
      i,
      this.nodeRegistry,
      a,
      t
    );
    return this.skipOptimization ? s : Au(s);
  }
}
const u0 = {
  buildHtml(e, u) {
...
t0.render({
  storeName: "Cool Cookies",
  customer: "John Doe"
}).then((e) => {
  console.log("escpos: ", [...e]);
});
