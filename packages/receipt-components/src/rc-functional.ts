import { ReceiptASTNode, ReceiptAST, parseTemplateForAst, ReceiptASTNodeRegistry } from "@resaleai/receipt-ast";
...
export async function renderRC<TProps, TRendererName extends keyof RendererMap>(component: FRC<TProps>, renderer: TRendererName, props: TProps, children?: ReceiptAST[]): Promise<RendererMap[TRendererName]> {
  // @ts-ignore
